...
export const HamburgerMenuIcon: React.FC<IconSVGProps> = ({ title, ...props }) => (
  <svg xmlns="http://www.w3.org/2000/svg" data-name="Layer 1" viewBox="0 0 566.67 433.33" fill="currentColor" {...props}>
    {title && <title>{title}</title>}
    <path d="M516.67 100H50C22.39 100 0 77.62 0 50S22.39 0 50 0h466.67c27.61 0 50 22.38 50 50s-22.39 50-50 50ZM516.67 266.67H50c-27.61 0-50-22.38-50-50s22.39-50 50-50h466.67c27.61 0 50 22.38 50 50s-22.39 50-50 50ZM516.67 433.33H50c-27.61 0-50-22.38-50-50s22.39-50 50-50h466.67c27.61 0 50 22.38 50 50s-22.39 50-50 50Z"/>
  </svg>
);

export const MangoIcon: React.FC<IconSVGProps> = ({ title, ...props }) => (
  <svg xmlns="http://www.w3.org/2000/svg" data-name="Layer 1" viewBox="0 0 1746.7 1860.54" fill="currentColor" {...props}>
    {title && <title>{title}</title>}
    <path d="M435.47,1860.5c-74.6.7-152.2-7.5-228.4-26.4-54.4-13.5-107.2-31.9-158.7-54-12.8-5.5-24.5-12.8-34.1-23.5-17.3-19.3-17.5-40.9-7.9-62.7,10.4-23.7,26-44.7,39.5-66.7,61.6-100.8,112.1-206.8,152.4-317.8,28-76.9,52.7-155,81.6-231.6,30.4-80.8,68.5-157.6,120.1-226.9,75.1-100.8,169.5-176.2,290.8-214.5,48.5-15.3,98.3-23,149.2-24,67.7-1.4,133.7,8.1,197.5,31.1,70.9,25.6,131.2,67.3,182.5,122.2,64.6,69.2,108.1,149.9,131.5,241.5,12.8,50.2,18.6,101.2,16.4,152.9-4.1,99-31.8,191.3-81,277.1-33,57.6-73.5,109.4-121.4,155.4-54.9,52.6-116.1,96.7-182.6,133.5-83.8,46.4-172.7,79.8-265.7,102.4-53.9,13.1-108.5,21.8-163.8,26.9-37.9,3.4-75.9,5.2-117.9,5.1ZM440.57,1737.2c4.5-.2,9.1-.6,13.6-.7,83.9-.7,166.7-10.9,247.9-32,111.1-28.8,214.7-74.1,307.5-142.5,85.6-63.1,153.7-140.7,196.2-239.1,31.2-72.3,44.8-147.9,36.4-226.5-7.2-67.8-29.6-130.6-66.9-187.8-35.7-54.7-80.9-99.6-139-130.5-43-22.9-89.2-34.6-137.5-39.7-45.6-4.8-90.7-2.4-135.6,6.9-79.3,16.3-145.6,56.4-204,111.1-50.9,47.7-88.2,105.2-120.1,166.6-28.2,54.1-49.1,111.3-68.6,168.9-25.9,76.5-52.7,152.6-82.1,227.8-35.2,90-79.4,175.5-128.9,258.4-5.8,9.8-5.8,10.1,3.2,13.3,89.9,32.3,182.8,46,277.9,45.8Z"/>
    <path d="M1324.67,365.4c-3.1,83.5-22.6,162.9-59.2,238-6.1,12.5-12.8,24.7-19.5,37-5.3,9.8-9.6,9.8-15.9.6-32.9-48.8-53.8-102.4-66-159.8-9.4-43.8-15.1-88-13.1-132.8,2.1-47.3,12-93.5,22.2-139.6,14.8-67.5,33.6-133.9,54.4-199.8,1.3-4.1,2.4-8.8,7.7-9,5-.1,6,4.4,7.2,8.2,29.7,90.8,56,182.5,73.8,276.6,5,26.6,8.5,53.3,8.4,80.6Z"/>
    <path d="M1552.57,588.4c71.6.4,128.4,9,184.5,23.2,4.2,1.1,8.6,2.1,9.5,7.3s-3,7.7-6.7,9.8c-80.6,46.1-164.8,82.3-258.1,92.4-64.1,6.9-126.4-.6-186.4-25.2-10.8-4.4-11.6-8.5-3.2-16.3,38.5-35.5,84.7-56.7,134.3-71.2,45.7-13.4,92.1-20.5,126.1-20Z"/>
    <path d="M1163.77,1149.4c.8,42.7-11.1,84.9-29.1,125.6-26.7,60.4-62.6,114.9-110.2,160.8-50.2,48.3-107.1,88-167.9,122-5,2.8-10,5.5-14.9,8.3-6.1,3.4-12.4,5.6-17.3-1.6-3.6-5.3-.4-11,8.6-15.7,18.6-9.8,36.9-20.3,54.6-31.7,45.7-29.4,90.2-60.8,128.3-99.9,58.2-59.9,101.1-129.3,121.9-211,11.4-44.8,7.5-89.7-1.2-134.5-2.3-12-.5-18.2,6.1-19.3,6.3-1.1,10.4,3.6,12.7,15.1,5.3,26.3,8.5,52.8,8.4,81.9Z"/>
  </svg>
);
